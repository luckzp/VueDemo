  ...
  <div>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="success" @click="handleSubmitAdd" :loading="formLoading">确 定</el-button>
      </div>
    </el-dialog>
    <el-dialog
      title="修改用户"
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="success" @click="handleSubmitUpdate" :loading="formLoading">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
.mainDiv {
  ...
  box-shadow: 0 5px 20px rgba(220, 222, 231, 0.65);
  padding: 30px;
}
</style>
<script>
